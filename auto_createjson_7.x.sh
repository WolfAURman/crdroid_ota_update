...
gapps="https://sourceforge.net/projects/nikgapps/files/Releases/NikGapps-R/11-Mar-2023/NikGapps-core-arm64-11-20230311-signed.zip/download" #https link (leave empty if unused)
